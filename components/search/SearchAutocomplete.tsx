      ...
      <form onSubmit={handleSubmit}>
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2.5 pr-12 border-2 border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400 transition"
            autoComplete="off"
          />
          <button
            type="submit"
            className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-700 p-1.5 rounded-lg transition-all"
          >
